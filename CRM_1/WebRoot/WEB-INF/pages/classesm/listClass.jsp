...
<table border="0" cellspacing="0" cellpadding="0" class="wukuang">
  <tr>
    ...
    <td width="36%"align="right">
    	...
    	<s:a namespace="/classesm" action="classAction_preAddOrEdit">
...
<thead>
  ...
  <s:iterator value="allClass" status="vs">
	  <tr class="<s:property value="#vs.even?'tabtd1':'tabtd2'"/>">
	    ...
	    <td align="center"><%@include file="getCalssState.jsp" %> </td>
		...
		<td align="center">
			<%--通过id查询 /html/classesm/viewClass.jsp --%>
	    	<s:a namespace="/classesm" action="classAction_findById">
	    		<s:param name="classId" value="classId"></s:param>
	    		<img src="${pageContext.request.contextPath}/images/button/view.gif" class="img"/>
	    	</s:a>
		</td>
		<td align="center" title="上次上传时间：<s:date name='uploadTime' format='yyyy-MM-dd' />">   
			<s:a namespace="/classesm" action="classAction_preUpload">
				<s:param name="classId" value="classId"></s:param>
				上传
			</s:a>
			<s:if test="uploadFilename != null">
				<s:a namespace="/classesm" action="classAction_download">
					<s:param name="classId" value="classId"></s:param>
					下载
				</s:a> <br/>
			</s:if>
