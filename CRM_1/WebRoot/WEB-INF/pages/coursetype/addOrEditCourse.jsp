...
<%-- 
<link href="${pageContext.request.contextPath}/js/ckeditor/samples/css/samples.css" type="text/css" rel="stylesheet" />
...
<table border="0" cellspacing="0" cellpadding="0"  class="wukuang"width="100%">
  <tr>
    ...
    <td width="44%" align="left">[课程类别管理]</td>
...
<s:form namespace="/coursetype" action="courseTypeAction_addOrEdit">
	<%--隐藏字段，存放编辑的id --%>
	...
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  ...
	  <tr>
	    <td>课程费用：</td>
	    <td><s:textfield class="ckeditor" name="courseCost"></s:textfield></td>
	    <td></td>
	    <td></td>
	  </tr>
	  <tr>
